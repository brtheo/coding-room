import type { IPost, IComment, sha } from '../types/Octoblog.d.ts'
...
export default function Post({post, isMainPage, comments, sha}: PostProps) {
  return (
    <>
      <article
        data-blog-post
      ...
      {!isMainPage 
        ? <Comment comments={comments} relatesTo={sha} />
        : null
      }
    </>  
  )
